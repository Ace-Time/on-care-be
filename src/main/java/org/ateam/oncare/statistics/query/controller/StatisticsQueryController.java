...
public class StatisticsQueryController {
    ...
    public ResponseEntity<java.util.List<org.ateam.oncare.statistics.query.dto.MonthlyClientStatsDTO>> getMonthlyClientStats() {
    ...
    public ResponseEntity<java.util.List<org.ateam.oncare.statistics.query.dto.MonthlyBeneficiaryStatsDTO>> getMonthlyBeneficiaryStats() {
    ...
    public ResponseEntity<java.util.List<org.ateam.oncare.statistics.query.dto.UnassignedBeneficiaryDTO>> getUnassignedBeneficiaries() {
    ...
    public ResponseEntity<java.util.List<org.ateam.oncare.statistics.query.dto.ChurnRiskBeneficiaryDTO>> getChurnRiskBeneficiaries() {
    ...
    public ResponseEntity<java.util.List<org.ateam.oncare.statistics.query.dto.RiskLevelBeneficiaryCountDTO>> getRiskLevelBeneficiaryCounts() {
